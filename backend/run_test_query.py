...
def run_test():
    ...
    input_payload = {
        "messages": [HumanMessage(content=f"What is the protagonist's iconic phrase? The information is in the file '{target_file_relative_to_project_root}'. Please read this specific file.")],
